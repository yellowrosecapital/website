...
export const siteContent = {
  ...
  pageMeta: {
    ...
    strategy: createPageMetadata({
      title: "Strategy",
      description:
        "Learn how Yellow Rose Capital serves accredited investors through private real estate credit centered on residential collateral, disciplined underwriting, and a relationship-based process.",
      path: "/strategy",
