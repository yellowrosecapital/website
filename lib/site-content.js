...
export const siteContent = {
    ...
    highlights: [
      {
        ...
        text: "We originate and acquire residential mortgage notes and short-term real estate loans, focusing on first-position liens, conservative leverage, and consistent income."
      },
      {
        title: "Market Focus",
        text: "We focus on Texas markets we know firsthand, prioritizing areas with durable housing demand, population growth, and long-term stability."
      },
      {
        title: "Our Approach",
        text: "We actively source, underwrite, and manage each investment with an emphasis on capital preservation, disciplined risk management, and consistent execution."
      }
    ],
    whatWeDo: [
  ...
  strategy: {
    ...
    process: [
      "Source real estate investment opportunities within target Texas markets.",
  ...
  leadership: [
    {
      ...
      bio: [
        "Nick Disney is a real estate investor based in San Antonio, Texas, with over 15 years of experience in residential real estate. He has completed hundreds of transactions across mortgage notes and property investments, with a focus on evaluating collateral, structuring deals, and managing risk from an operator’s perspective.",
        "He is a co-founder of Yellow Rose Capital, where he helps lead the firm’s investment strategy with an emphasis on disciplined underwriting and long-term, income-focused investing.",
        "Nick approaches investing with a focus on clarity, alignment, and long-term relationships, and values helping investors understand how to participate in real estate in a more thoughtful and structured way.",
        "He graduated from Texas A&M University with a degree in Biomedical Science and began his career in medical sales before transitioning into real estate full-time. He lives in Bulverde, Texas with his wife and three children."
      ],
      strengths: []
    },
    {
      ...
      bio: [
        "Jacob Martinez is a real estate investor based in San Antonio, Texas, with extensive experience in off-market single-family acquisitions and local residential markets. His work focuses on sourcing opportunities, underwriting deals, and executing transactions with a disciplined, operator-driven approach.",
        "He is a co-founder of Yellow Rose Capital, where he helps lead the firm’s acquisition strategy and market execution, leveraging deep familiarity with the San Antonio area and surrounding communities.",
        "Jacob is a U.S. Air Force veteran and former San Antonio firefighter, bringing a service-oriented mindset, leadership, and consistency to his work in real estate. He is actively involved in the local community and remains committed to long-term impact both through investing and service.",
        "He lives in San Antonio with his wife and daughters."
      ],
      strengths: []
    }
  ],
