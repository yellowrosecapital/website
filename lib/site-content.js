...
export const siteContent = {
  ...
  home: {
    hero: {
      ...
      lead:
        "Yellow Rose Capital is a private real estate credit firm based in San Antonio, Texas, focused on accredited individual investors who want passive exposure to residential real estate, disciplined underwriting, and diversification outside public markets.",
      note:
        "The public site introduces the firm, its philosophy, and its strategy at a high level. Detailed offering information is shared privately with qualified investors through confidential materials."
    },
    highlights: [
      {
