...
export const siteContent = {
  ...
  strategy: {
      ...
      process: [
        "Source residential credit opportunities in target Texas markets.",
        "Underwrite collateral, borrower profile, and loan structure.",
        "Deploy capital through affiliated vehicles after qualification.",
        "Share detailed economics through private materials and direct conversations."
      ]
    },
  passive: {
    intro:
