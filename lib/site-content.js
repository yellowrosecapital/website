    ...
    highlights: [
      {
        ...
        text: "We focus on income-producing investments backed by residential real estate rather than relying on appreciation or speculation."
      },
      {
        title: "Texas Market Expertise",
        text: "Our strategy is built around deep familiarity with the San Antonio market and surrounding Texas communities where we actively operate."
      },
      {
        title: "Operator-Led Management",
        text: "Investors participate passively while our team handles sourcing, underwriting, and ongoing portfolio management."
      }
    ],
    whatWeDo: [
