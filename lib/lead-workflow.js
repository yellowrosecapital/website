...
const DEFAULT_CRM_WEBHOOK_URL = "https://hooks.zapier.com/hooks/catch/3903592/u73uc7w/";
...
export function buildLeadRecord(input = {}) {
  ...
  const investorType = typeof input.investorType === "string" ? input.investorType.trim() : "";
  const accreditedStatus = typeof input.accreditedStatus === "string" ? input.accreditedStatus.trim() : "";
  const investmentRange = typeof input.investmentRange === "string" ? input.investmentRange.trim() : "";
