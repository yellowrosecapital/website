...
export const growthContent = {
  shareSnippets: [
    "Passive real estate investing backed by real assets, residential collateral, and disciplined underwriting.",
    "Yellow Rose Capital focuses on private real estate credit for accredited individual investors in Texas markets.",
    "Educational content about mortgage notes, first-position liens, and passive investor education."
  ],
  copyBlocks: [
    "Learn how passive real estate investing can provide real estate exposure without direct property management.",
    "Explore educational insights about private credit, residential note strategy, and Texas market familiarity.",
    "Request information if you want a private conversation about qualified investor fit."
  ],
  posts: [
    {
